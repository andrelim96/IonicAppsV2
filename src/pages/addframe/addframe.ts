...
export class AddFramePage {
  ...
  selectFrame(frame:string){
    if(frame==='frame01'){
      this.frame = "assets/images/frame01.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame02'){
      this.frame = "assets/images/frame02.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame03'){
      this.frame = "assets/images/frame03.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame04'){
      this.frame = "assets/images/frame04.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame05'){
      this.frame = "assets/images/frame05.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame06'){
      this.frame = "assets/images/frame06.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame07'){
      this.frame = "assets/images/frame07.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame08'){
      this.frame = "assets/images/frame08.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame09'){
      this.frame = "assets/images/frame09.png";
      this.ngAfterViewInit();
    }
    else if(frame==='frame10'){
      this.frame = "assets/images/frame10.png";
      this.ngAfterViewInit();
    }
  }
  ...
  moveTeam(){
    this.navi.setRoot(TeammatePhotosPage);
  }
